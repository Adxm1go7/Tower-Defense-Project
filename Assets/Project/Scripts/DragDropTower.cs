...
public class DragDropTower : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        if (!gameManager.canPlaceTower(towerPrefab.towerCost) || gameManager.isPaused) //check if there is enough coins to place tower
        {
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (gameManager.canPlaceTower(towerPrefab.towerCost)) //check if there is enough coins to place tower
        {
            ...
            gameManager.deductCoins(towerPrefab.towerCost); //Deduct coins only if placement is valid
        }
